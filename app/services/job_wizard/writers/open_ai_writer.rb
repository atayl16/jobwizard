...
module JobWizard
  module Writers
    class OpenAiWriter
      ...
      def cover_letter(company:, role:, jd_text:, profile:, experience:, tone: 'warm, professional, concise', meta: {})
      ...
      def resume_snippets(company:, role:, jd_text:, profile:, experience:, meta: {})
      ...
      def call_openai_with_tracking!(system:, user:, temperature:, feature:, meta:)
